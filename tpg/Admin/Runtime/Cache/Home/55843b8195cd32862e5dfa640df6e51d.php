    ...
    <div class="am-g tpl-g">
        ...
        <div class="tpl-login">
            <div class="tpl-login-content">
                ...
                <form class="am-form tpl-form-line-form" action="/tpg/admin.php/home/adminform/indexdeal" method="post">
                    <div class="am-form-group">
                        <input type="email" class="tpl-form-input" id="user-name" placeholder="请输入邮箱号" name="adminemail"  required="required"/>

                    </div>

                    <div class="am-form-group">
                        <input type="password" class="tpl-form-input" id="user-name" placeholder="请输入密码" name=" adminpassword"  required="required"/>
