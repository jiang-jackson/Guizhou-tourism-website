                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">美食修改表单</div>
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="/tpg/admin.php/home/Adminform/meishiupdate1?id=<?php echo ($meishis["id"]); ?>" method="post" enctype="multipart/form-data">
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">美食名称 <span class="tpl-form-line-small-title">Name</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" placeholder="请输入美食名称" name="meishi_name" value='<?php echo ($meishis["meishi_name"]); ?>' required/>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" placeholder="输入数字+元" name="meishi_price" value='<?php echo ($meishis["meishi_price"]); ?>'>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" placeholder="输入城市" name="meishi_site" value='<?php echo ($meishis["meishi_site"]); ?>' required/>
                                        </div>
                                    </div>
                             ...
                             <i class="am-icon-cloud-upload"></i> 修改美食封面图片</button>
                                                <input id="doc-form-file" type="file" multiple="" name="meishi_image"/>
                                                <img src="<?php echo ($meishis["meishi_image"]); ?>" alt="" class="am-img-responsive">
                                            </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea class="" rows="10" id="user-intro" placeholder="请输入内容" name="meishi_content" required/><?php echo ($meishis['meishi_content']); ?></textarea>
                                        </div>
                                    </div>
