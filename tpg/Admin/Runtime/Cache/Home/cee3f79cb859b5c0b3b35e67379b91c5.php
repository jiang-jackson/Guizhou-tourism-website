...
<div class="tpl-content-wrapper">
            ...
            <div class="container-fluid am-cf">
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 信息修改页面 <small>贵州旅游</small></div>
 ...
 <div class="row-content am-cf">
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">景点修改表单</div>
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="/tpg/admin.php/home/Adminform/jingdianupdate1?id=<?php echo ($jingdian["jingdian_id"]); ?>" method="post" enctype="multipart/form-data">
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">景点名称 <span class="tpl-form-line-small-title">Name</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" placeholder="请输入标题文字" name="jingdian_name" value="<?php echo ($jingdian["jingdian_name"]); ?>" required="required">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" placeholder="输入城市" name="jingdian_site" value="<?php echo ($jingdian["jingdian_site"]); ?>" required="required">
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" placeholder="价格" name="jingdian_price" value="<?php echo ($jingdian["jingdian_price"]); ?>" required="required">
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" placeholder="输入文字" name="jingdian_trait" value="<?php echo ($jingdian["jingdian_trait"]); ?>"  required="required">
                                        </div>
                                    </div>
    ...
    <i class="am-icon-cloud-upload"></i> 修改景点封面图片</button>
                                                <input id="doc-form-file" type="file" multiple="" name="jingdin_image">
                                                <img src="<?php echo ($jingdian["jingdian_image"]); ?>" alt="" class="am-img-responsive">
                                            </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea class="" rows="10" id="user-intro" placeholder="请输入文章内容" name="jingdian_content" required="required"><?php echo ($jingdian["jingdian_content"]); ?></textarea>
                                        </div>
                                    </div>
