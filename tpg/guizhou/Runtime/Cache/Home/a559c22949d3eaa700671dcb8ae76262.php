  ...
  <div class="container margin-nav">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav wow bounceInRight">
        ...
        <li   class="active"><a href="/tpg/home/cate/cate">舌尖美食</a></li>
...
<!-- //Custom Theme files -->
<!-- <link href="/tpg/Public/hotels/css/bootstrap.css" type="text/css" rel="stylesheet" media="all"> -->
<link href="/tpg/Public/hotels/css/style.css" type="text/css" rel="stylesheet" media="all">
<link rel="stylesheet" href="/tpg/Public/hotels/css/flexslider.css" type="text/css" media="screen" />
<link type="text/css" rel="stylesheet" href="/tpg/Public/hotels/css/JFFormStyle-1.css" />
<!-- js -->
<script src="/tpg/Public/hotels/js/jquery.min.js"></script>
<script src="/tpg/Public/hotels/js/modernizr.custom.js"></script>
<!-- //js -->
...
<!--pop-up-->
<script src="/tpg/Public/hotels/js/menu_jquery.js"></script>
<!--//pop-up-->	
</head>
<body>
				...
				<div class="blog-grids">
					<div class="col-md-8 blog-left">
						<div class="blog-left-grid">
							<p>地区 : <a href="#"><?php echo ($cate["meishi_site"]); ?></a> &nbsp;&nbsp; on <?php echo ($cate["birth"]); ?> &nbsp;&nbsp; 价格 : <a href="#"> <?php echo ($cate["meishi_price"]); ?></a></p>
							<a href="#"><img src="<?php echo ($cate["meishi_image"]); ?>" alt=""></a>
							<div class="blog-left-right">
								<a href="#"><?php echo ($cate["meishi_name"]); ?></a>
								<p><?php echo ($cate["meishi_content"]); ?>
								</p>
							</div>
						</div>
						<!--<div class="blog-left-grid">
					...
					<div class="col-md-4 blog-right">
						<div class="Categories">
							<h3>酒店推荐</h3>
							<ul>
							<?php if(is_array($hotels)): $i = 0; $__LIST__ = $hotels;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hotel): $mod = ($i % 2 );++$i;?><li><a href="/tpg/home/show/showhotel?id=<?php echo ($hotel["jiudian_id"]); ?>"><?php echo ($hotel["jiudian_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
						...
						<div class="comments">
							<h3>热门景点</h3>
							<?php if(is_array($jingdians)): $i = 0; $__LIST__ = $jingdians;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$jingdian): $mod = ($i % 2 );++$i;?><div class="comments-text">
								<div class="col-md-3 comments-left">
									<img src="<?php echo ($jingdian["jingdian_image"]); ?>" alt="">
								</div>
								<div class="col-md-9 comments-right">
									<h5><?php echo ($jingdian["jingdian_name"]); ?></h5>
									<a href="/tpg/home/show/showjingdian?id=<?php echo ($jingdian["jingdian_id"]); ?>"><?php echo ($jingdian["jingdian_trait"]); ?></a> 
									<p><?php echo ($jingdian["jingdian_prith"]); ?></p>
								</div>
...
<script defer src="/tpg/Public/hotels/js/jquery.flexslider.js"></script>
  <script src="/tpg/Public/hotels/js/easyResponsiveTabs.js" type="text/javascript"></script>
  <script src="/tpg/Public/hotels/js/jquery-ui.js"></script>
  <script type="text/javascript" src="/tpg/Public/hotels/js/script.js"></script>
  <script type="text/javascript">
    $(function(){
