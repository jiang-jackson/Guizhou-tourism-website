  ...
  <div class="container margin-nav">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav wow bounceInRight">
        ...
        <li  class="active"><a href="/tpg/home/hotels/hotel">酒店信息</a></li>
        ...
        <div class="single-page">
            <div class="col-md-8 single-gd-lt">
              <div class="single-pg-hdr">
                <h2><?php echo ($hotel["jiudian_name"]); ?></h2>
                <p><?php echo ($hotel["jiudian_content"]); ?></p>
                <p>地点：<a href="#"><?php echo ($hotel["jiudian_site"]); ?> </a> 价格 ：<a href="#"><?php echo ($hotel["jiudian_price"]); ?> </a> 星级 ：<a href="#"><?php echo ($hotel["jiudian_star"]); ?></a></p>
              </div>
              <div class="flexslider">
                      <ul class="slides">
                        <li data-thumb="<?php echo ($hotel["jiudian_image"]); ?>">
                          <img src="<?php echo ($hotel["jiudian_image"]); ?>" alt=""/>
                        </li>
                        <li data-thumb="<?php echo ($hs["jiudian_image"]); ?>">
                          <img src="<?php echo ($hs["jiudian_image"]); ?>" alt=""/>
                        </li>
            ...
            <div class="col-md-4 single-gd-rt">
              <div class="spl-btn">
                ...
                <div class="sp-bor-btn text-right">
                  <h4><span>$480</span> $299</h4>
                  <p class="best-pri">Best price</p>
                  <a class="best-btn" href="<?php echo ($hotel["jiudian_tel"]); ?>">Book Now</a>
                </div>
              </div>
             <!--  <div class="map-gd">
              ...
              <div class="other-comments">
                ...
                <?php if(is_array($jingdians)): $i = 0; $__LIST__ = $jingdians;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$jingdian): $mod = ($i % 2 );++$i;?><div class="comments-bot">
                  <p><?php echo ($jingdian["jingdian_content"]); ?></p>
                  <h4><span class="glyphicon glyphicon-minus" aria-hidden="true"></span> <a href="/tpg/home/show/showjingdian?id=<?php echo ($jingdian["jingdian_id"]); ?>" title=""><?php echo ($jingdian["jingdian_name"]); ?></a></h4>
