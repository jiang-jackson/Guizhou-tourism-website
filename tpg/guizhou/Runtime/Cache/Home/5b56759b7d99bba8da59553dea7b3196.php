...
<link rel="stylesheet" type="text/css" href="/tpg/Public/show/css/style.css">
<link rel="stylesheet" type="text/css" href="/tpg/Public/show/assets/css/amazeui.min.css">
<script src="/tpg/Public/show/assets/js/amazeui.min.js"></script>
  ...
  <div class="background" style="height: 100%;">
		<div class="page" >
			<div class="logo" style="margin-top: 10px;">
				<span> <a href="/tpg/home/about/about"><img src="/tpg/Public/show/images/logo.png" alt=""></a> </span>
			</div>
			<div class="sidebar">
				<ul>
					<li >
					...
					<li>
						<a href="/tpg/home/jingdian/jingdian">旅游景点</a>
					</li>
					<li>
						<a href="/tpg/home/login/tuichu">退出</a>
					</li>
			...
			<div class="body">
				<ul>
					<li class="first">
						<h3><a href="/tpg/home/show/more?name=jingdian"><?php echo ($jingdians["jingdian_name"]); ?></a></h3>
						<span style="font-size: 18px;">所在地区 ：<?php echo ($jingdians["jingdian_site"]); ?></span> 
						<span style="font-size: 16px;">门票 ：<strong style="color:red;"><?php echo ($jingdians["jingdian_price"]); ?></strong></span> 
						<span style="font-size: 18px;"><strong style="color: #00ffff;">景点特色 </strong>：<?php echo ($jingdians["jingdian_trait"]); ?></span> 
						<a href="/tpg/home/show/more?name=jingdian"><img src="<?php echo ($jingdians["jingdian_image"]); ?>" alt="" width="760" height='400'></a>
						<p>
							<?php echo ($jingdians["jingdian_name"]); ?> ：<?php echo ($jingdians["jingdian_content"]); ?>
						</p>
					</li>
					<li class="second">
						
						<h3 style="margin-left: 20px;"><a href="#">评论列表</a></h3>
						
						<p>
						<?php if(is_array($pingluns)): $i = 0; $__LIST__ = $pingluns;if( count($__LIST__)==0 ) : echo "暂无评论" ;else: foreach($__LIST__ as $key=>$pinglun): $mod = ($i % 2 );++$i;?><article class="am-comment"> <!-- 评论容器 -->
  <!-- <a href="">
    <img class="am-comment-avatar" alt=""/> <!-- 评论者头像 -->
  <!-- </a> -->

  <div class="am-comment-main" style="margin-left: 1px;margin-top: 10px;"> <!-- 评论内容容器 -->
    <header class="am-comment-hd" style="background-color: blue; color: black;">
      <!--<h3 class="am-comment-title">评论标题</h3>-->
      <div class="am-comment-meta"> <!-- 评论元数据 -->
        <a href="#link-to-user" class="am-comment-author" style="color: red;"><?php echo ($pinglun["username"]); ?></a> <!-- 评论者 -->
        评论于 <time datetime=""><?php echo ($pinglun["pinglun_birth"]); ?></time>
      </div>
    </header>

    <div class="am-comment-bd" style="background-color: #fff;"><?php echo ($pinglun["pinglun_content"]); ?></div> <!-- 评论内容 -->
  </div>
</article><?php endforeach; endif; else: echo "暂无评论" ;endif; ?>
							
						</p>

						<!-- 评论 -->
						<form action="/tpg/home/show/pinglundeal" class="am-form" id="doc-vld-msg" method="post">
  
    <div class="am-form-group">
      <label for="doc-vld-ta-2-1">评论：</label>
      <textarea id="doc-vld-ta-2-1" rows="5" cols="10" required name="content"></textarea>
      <span id="ajaxspan" style="color: red;"></span>
    </div>
...
$("textarea").bind("keyup",function(){
	// $val = $("#doc-vld-ta-2-1").val();
	// console.log($val);
	$.ajax({
		url:"/tpg/home/show/pinglunajax",
		dataType : 'json',
		success:function(data){
			...
			if (data == 1) {
				...
				$('#ajaxspan').html('只有登录后才能评论');
					...
					<li class="third">
						<h3><a href="blog.html">推荐景点</a></h3>
						<a href="" ><img src="<?php echo ($tuijian["jingdian_image"]); ?>" alt="" width="340" height="220"></a> <span>添加时间 : <?php echo ($tuijian["jingdian_birth"]); ?></span>
						<p style="clear: both;">
							<?php echo ($tuijian["jingdian_name"]); ?> : <?php echo ($tuijian["jingdian_content"]); ?>
						</p>
					</li>
				</ul>
			</div>
